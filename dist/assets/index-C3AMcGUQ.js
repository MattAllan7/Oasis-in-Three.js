...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(e,t,n){let r=new Float32Array(ks),i=new W(0,1,0);return new ja({name:`SphericalGaussianBlur`,defines:{n:ks,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ks(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(){return new ja({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ks(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Gs(){return new ja({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ks(),fragmentShader:`
	...
	`}var qs=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new _a([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var vl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function yl(e,t){let n=vl[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var bl=new W;function xl(){return K.getLuminanceCoefficients(bl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${bl.x.toFixed(4)}, ${bl.y.toFixed(4)}, ${bl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ul(i,i.VERTEX_SHADER,y),S=ul(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=gl(i,x,`vertex`),n=gl(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`),r=[];for(let e=0,i=n.length;e<i;e++){let i=n[e].trimStart();if(i.length===0)continue;let a=i.charAt(0);if(a!==`#`)if(a===`v`){let e=i.split(Hu);switch(e[0]){case`v`:t.vertices.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3])),e.length>=7?(Ju.setRGB(parseFloat(e[4]),parseFloat(e[5]),parseFloat(e[6]),Be),t.colors.push(Ju.r,Ju.g,Ju.b)):t.colors.push(void 0,void 0,void 0);break;case`vn`:t.normals.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3]));break;case`vt`:t.uvs.push(parseFloat(e[1]),parseFloat(e[2]));break}}else if(a===`f`){let e=i.slice(1).trim().split(Hu),n=[];for(let t=0,r=e.length;t<r;t++){let r=e[t];if(r.length>0){let e=r.split(`/`);n.push(e)}}let r=n[0];for(let e=1,i=n.length-1;e<i;e++){let i=n[e],a=n[e+1];t.addFace(r[0],i[0],a[0],r[1],i[1],a[1],r[2],i[2],a[2])}}else if(a===`l`){let e=i.substring(1).trim().split(` `),n=[],r=[];if(i.indexOf(`/`)===-1)n=e;else for(let t=0,i=e.length;t<i;t++){let i=e[t].split(`/`);i[0]!==``&&n.push(i[0]),i[1]!==``&&r.push(i[1])}t.addLineGeometry(n,r)}else if(a===`p`){let e=i.slice(1).trim().split(` `);t.addPointGeometry(e)}else if((r=Ru.exec(i))!==null){let e=(` `+r[0].slice(1).trim()).slice(1);t.startObject(e)}else if(Bu.test(i))t.object.startMaterial(i.substring(7).trim(),t.materialLibraries);else if(zu.test(i))t.materialLibraries.push(i.substring(7).trim());else if(Vu.test(i))console.warn(`THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.`);else if(a===`s`){if(r=i.split(` `),r.length>1){let e=r[1].trim().toLowerCase();t.object.smooth=e!==`0`&&e!==`off`}else t.object.smooth=!0;let e=t.object.currentMaterial();e&&(e.smooth=t.object.smooth)}else{if(i===`\0`)continue;console.warn(`THREE.OBJLoader: Unexpected line: "`+i+`"`)}}t.finalize();let i=new Tn;if(i.materialLibraries=[].concat(t.materialLibraries),!(t.objects.length===1&&t.objects[0].geometry.vertices.length===0))for(let e=0,n=t.objects.length;e<n;e++){let n=t.objects[e],r=n.geometry,a=n.materials,o=r.type===`Line`,s=r.type===`Points`,c=!1;if(r.vertices.length===0)continue;let l=new Dr;l.setAttribute(`position`,new hr(r.vertices,3)),r.normals.length>0&&l.setAttribute(`normal`,new hr(r.normals,3)),r.colors.length>0&&(c=!0,l.setAttribute(`color`,new hr(r.colors,3))),r.hasUVIndices===!0&&l.setAttribute(`uv`,new hr(r.uvs,2));let u=[];for(let e=0,n=a.length;e<n;e++){let n=a[e],r=n.name+`_`+n.smooth+`_`+c,i=t.materials[r];if(this.materials!==null){if(i=this.materials.create(n.name),o&&i&&!(i instanceof Xi)){let e=new Xi;Mr.prototype.copy.call(e,i),e.color.copy(i.color),i=e}else if(s&&i&&!(i instanceof ua)){let e=new ua({size:10,sizeAttenuation:!1});Mr.prototype.copy.call(e,i),e.color.copy(i.color),e.map=i.map,i=e}}i===void 0&&(i=o?new Xi:s?new ua({size:1,sizeAttenuation:!1}):new Fa,i.name=n.name,i.flatShading=!n.smooth,i.vertexColors=c,t.materials[r]=i),u.push(i)}let d;if(u.length>1){for(let e=0,t=a.length;e<t;e++){let t=a[e];l.addGroup(t.groupStart,t.groupCount,e)}d=o?new ca(l,u):s?new ha(l,u):new hi(l,u)}else d=o?new ca(l,u[0]):s?new ha(l,u[0]):new hi(l,u[0]);d.name=n.name,i.add(d)}else if(t.vertices.length>0){let e=new ua({size:1,sizeAttenuation:!1}),n=new Dr;n.setAttribute(`position`,new hr(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(n.setAttribute(`color`,new hr(t.colors,3)),e.vertexColors=!0);let r=new ha(n,e);i.add(r)}return i}};function Zu(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function Qu(e){let t=new Map,n=new Map,r=e.clone();return $u(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function $u(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)$u(e.children[r],t.children[r],n)}var ed=class extends so{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new od(e)}),this.register(function(e){return new sd(e)}),this.register(function(e){return new gd(e)}),this.register(function(e){return new _d(e)}),this.register(function(e){return new vd(e)}),this.register(function(e){return new ld(e)}),this.register(function(e){return new ud(e)}),this.register(function(e){return new dd(e)}),this.register(function(e){return new fd(e)}),this.register(function(e){return new ad(e)}),this.register(function(e){return new pd(e)}),this.register(function(e){return new cd(e)}),this.register(function(e){return new hd(e)}),this.register(function(e){return new md(e)}),this.register(function(e){return new rd(e)}),this.register(function(e){return new yd(e,Z.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new yd(e,Z.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new bd(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=Lo.extractUrlBase(e);a=Lo.resolveURL(t,this.path)}else a=Lo.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new uo(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===xd){try{a[Z.KHR_BINARY_GLTF]=new wd(e)}catch(e){r&&r(e);return}i=JSON.parse(a[Z.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new Xd(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case Z.KHR_MATERIALS_UNLIT:a[t]=new id;break;case Z.KHR_DRACO_MESH_COMPRESSION:a[t]=new Td(i,this.dracoLoader);break;case Z.KHR_TEXTURE_TRANSFORM:a[t]=new Ed;break;case Z.KHR_MESH_QUANTIZATION:a[t]=new Dd;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function td(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function nd(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var Z={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},rd=class{constructor(e){this.parser=e,this.name=Z.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new J(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Ve);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Fo(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new Mo(s),o.distance=c;break;case`spot`:o=new Ao(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),Hd(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},id=class{constructor(){this.name=Z.KHR_MATERIALS_UNLIT}getMaterialType(){return ri}extendParams(e,t,n){let r=[];e.color=new J(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Ve),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Be))}return Promise.all(r)}},ad=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},od=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new U(e,e)}return Promise.all(r)}},sd=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_DISPERSION}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},cd=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},ld=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_SHEEN}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new J(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Ve)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Be)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},ud=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},dd=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_VOLUME}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new J().setRGB(i[0],i[1],i[2],Ve),Promise.all(r)}},fd=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_IOR}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);return n===null||(t.ior=n.ior===void 0?1.5:n.ior),Promise.resolve()}},pd=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_SPECULAR}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new J().setRGB(i[0],i[1],i[2],Ve),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Be)),Promise.all(r)}},md=class{constructor(e){this.parser=e,this.name=Z.EXT_MATERIALS_BUMP}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},hd=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return nd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=nd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},gd=class{constructor(e){this.parser=e,this.name=Z.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},_d=class{constructor(e){this.parser=e,this.name=Z.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},vd=class{constructor(e){this.parser=e,this.name=Z.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},yd=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},bd=class{constructor(e){this.name=Z.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==jd.TRIANGLES&&e.mode!==jd.TRIANGLE_STRIP&&e.mode!==jd.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new q,n=new W,a=new kt,s=new W(1,1,1),c=new Vi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new Ni(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);wn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},xd=`glTF`,Sd=12,Cd={JSON:1313821514,BIN:5130562},wd=class{constructor(e){this.name=Z.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Sd),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==xd)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Sd,i=new DataView(e,Sd),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Cd.JSON){let r=new Uint8Array(e,Sd+a,t);this.content=n.decode(r)}else if(r===Cd.BIN){let n=Sd+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},Td=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=Z.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=Id[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=Id[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=Md[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Ve,n)})})}},Ed=class{constructor(){this.name=Z.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Dd=class{constructor(){this.name=Z.KHR_MESH_QUANTIZATION}},Od=class extends Ha{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},kd=new kt,Ad=class extends Od{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return kd.fromArray(i).normalize().toArray(i),i}},jd={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},Md={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Nd={9728:i,9729:s,9984:a,9985:c,9986:o,9987:l},Pd={33071:n,33648:r,10497:t},Fd={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Id={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},Ld={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},Rd={CUBICSPLINE:void 0,LINEAR:I,STEP:Ne},zd={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function Bd(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Na({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function Vd(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function Hd(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function Ud(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function Wd(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function Gd(e){let t,n=e.extensions&&e.extensions[Z.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+Kd(n.attributes):e.indices+`:`+Kd(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+Kd(e.targets[n]);return t}function Kd(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function qd(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function Jd(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var Yd=new q,Xd=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new td,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new ho(this.options.manager):this.textureLoader=new zo(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new uo(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return Vd(i,a,r),Hd(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+ e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Z.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(Lo.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=Fd[r.type],t=Md[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new fr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=Fd[r.type],o=Md[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Or(f,u/s),t.cache.add(n,c)),p=new Ar(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new fr(f,a,d);if(r.sparse!==void 0){let t=Fd.SCALAR,n=Md[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new fr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=Nd[n.magFilter]||1006,t.minFilter=Nd[n.minFilter]||1008,t.wrapS=Pd[n.wrapS]||1e3,t.wrapT=Pd[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Gt(e);t.needsUpdate=!0,n(t)}),t.load(Lo.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),Hd(e,a),e.userData.mimeType=a.mimeType||Jd(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[Z.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[Z.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[Z.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new ua,Mr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Xi,Mr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Na}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[Z.KHR_MATERIALS_UNLIT]){let e=r[Z.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new J(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Ve),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Be)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||zd.OPAQUE;if(l===zd.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===zd.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==ri&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new U(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==ri&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==ri){let e=i.emissiveFactor;o.emissive=new J().setRGB(e[0],e[1],e[2],Ve)}return i.emissiveTexture!==void 0&&a!==ri&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Be)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),Hd(n,i),t.associations.set(n,{materials:e}),i.extensions&&Vd(r,n,i),n})}createUniqueName(e){let t=rs.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[Z.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return Qd(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=Gd(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[Z.KHR_DRACO_MESH_COMPRESSION]?i(o):Qd(new Dr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?Bd(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===jd.TRIANGLES||u.mode===jd.TRIANGLE_STRIP||u.mode===jd.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new Di(l,f):new hi(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===jd.TRIANGLE_STRIP?d.geometry=Zu(d.geometry,1):u.mode===jd.TRIANGLE_FAN&&(d.geometry=Zu(d.geometry,2));else if(u.mode===jd.LINES)d=new ca(l,f);else if(u.mode===jd.LINE_STRIP)d=new ia(l,f);else if(u.mode===jd.LINE_LOOP)d=new la(l,f);else if(u.mode===jd.POINTS)d=new ha(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&Wd(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),Hd(d,i),u.extensions&&Vd(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&Vd(r,c[0],i),c[0];let l=new Tn;i.extensions&&Vd(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new Oo(Ot.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new No(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Hd(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new q;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new Mi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new to(i,void 0,l);return Hd(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,Yd)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new W().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new Oi:t.length>1?new Tn:t.length===1?t[0]:new wn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),Hd(o,i),i.extensions&&Vd(n,o,i),i.matrix!==void 0){let e=new q;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new Tn;n.name&&(i.name=r.createUniqueName(n.name)),Hd(i,n),n.extensions&&Vd(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(Qu(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Mr||e instanceof Gt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];Ld[i.path]===Ld.weights?e.traverse(function(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}):s.push(o);let c;switch(Ld[i.path]){case Ld.weights:c=Xa;break;case Ld.rotation:c=Qa;break;case Ld.translation:case Ld.scale:c=eo;break;default:switch(n.itemSize){case 1:c=Xa;break;default:c=eo;break}break}let l=r.interpolation===void 0?I:Rd[r.interpolation],u=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new c(s[e]+`.`+Ld[i.path],t.array,u,l);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=qd(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Qa?Ad:Od)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Zd(e,t,n){let r=t.attributes,i=new Jn;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new W(t[0],t[1],t[2]),new W(a[0],a[1],a[2])),e.normalized){let t=qd(Md[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new W,t=new W;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=qd(Md[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new yr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function Qd(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=Id[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return K.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${K.workingColorSpace}" not supported.`),Hd(e,t),Zd(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:Ud(e,t.targets,n)})}var $d=class extends hi{constructor(e,t={}){super(e),this.isWater=!0;let n=this,r=t.textureWidth===void 0?512:t.textureWidth,i=t.textureHeight===void 0?512:t.textureHeight,a=t.clipBias===void 0?0:t.clipBias,o=t.alpha===void 0?1:t.alpha,s=t.time===void 0?0:t.time,c=t.waterNormals===void 0?null:t.waterNormals,l=t.sunDirection===void 0?new W(.70707,.70707,0):t.sunDirection,u=new J(t.sunColor===void 0?16777215:t.sunColor),d=new J(t.waterColor===void 0?8355711:t.waterColor),f=t.eye===void 0?new W(0,0,0):t.eye,p=t.distortionScale===void 0?20:t.distortionScale,m=t.side===void 0?0:t.side,h=t.fog===void 0?!1:t.fog,g=new Gi,v=new W,y=new W,b=new W,x=new q,S=new W(0,0,-1),C=new Kt,w=new W,T=new W,E=new Kt,D=new q,O=new Oo,ee=new Jt(r,i,{type:_}),k={name:`MirrorShader`,uniforms:Oa.merge([X.fog,X.lights,{normalSampler:{value:null},mirrorSampler:{value:null},alpha:{value:1},time:{value:0},size:{value:1},distortionScale:{value:20},textureMatrix:{value:new q},sunColor:{value:new J(8355711)},sunDirection:{value:new W(.70707,.70707,0)},eye:{value:new W},waterColor:{value:new J(5592405)}}]),vertexShader:`
				...
				void main() {
					...
					#include <colorspace_fragment>
					#include <fog_fragment>	
				}`},A=new ja({name:k.name,uniforms:Oa.clone(k.uniforms),vertexShader:k.vertexShader,fragmentShader:k.fragmentShader,lights:!0,side:m,fog:h});A.uniforms.mirrorSampler.value=ee.texture,A.uniforms.textureMatrix.value=D,A.uniforms.alpha.value=o,A.uniforms.time.value=s,A.uniforms.normalSampler.value=c,A.uniforms.sunColor.value=u,A.uniforms.waterColor.value=d,A.uniforms.sunDirection.value=l,A.uniforms.distortionScale.value=p,A.uniforms.eye.value=f,n.material=A,n.onBeforeRender=function(e,t,r){if(y.setFromMatrixPosition(n.matrixWorld),b.setFromMatrixPosition(r.matrixWorld),x.extractRotation(n.matrixWorld),v.set(0,0,1),v.applyMatrix4(x),w.subVectors(y,b),w.dot(v)>0)return;w.reflect(v).negate(),w.add(y),x.extractRotation(r.matrixWorld),S.set(0,0,-1),S.applyMatrix4(x),S.add(b),T.subVectors(y,S),T.reflect(v).negate(),T.add(y),O.position.copy(w),O.up.set(0,1,0),O.up.applyMatrix4(x),O.up.reflect(v),O.lookAt(T),O.far=r.far,O.updateMatrixWorld(),O.projectionMatrix.copy(r.projectionMatrix),D.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),D.multiply(O.projectionMatrix),D.multiply(O.matrixWorldInverse),g.setFromNormalAndCoplanarPoint(v,y),g.applyMatrix4(O.matrixWorldInverse),C.set(g.normal.x,g.normal.y,g.normal.z,g.constant);let i=O.projectionMatrix;E.x=(Math.sign(C.x)+i.elements[8])/i.elements[0],E.y=(Math.sign(C.y)+i.elements[9])/i.elements[5],E.z=-1,E.w=(1+i.elements[10])/i.elements[14],C.multiplyScalar(2/C.dot(E)),i.elements[2]=C.x,i.elements[6]=C.y,i.elements[10]=C.z+1-a,i.elements[14]=C.w,f.setFromMatrixPosition(r.matrixWorld);let o=e.getRenderTarget(),s=e.xr.enabled,c=e.shadowMap.autoUpdate;n.visible=!1,e.xr.enabled=!1,e.shadowMap.autoUpdate=!1,e.setRenderTarget(ee),e.state.buffers.depth.setMask(!0),e.autoClear===!1&&e.clear(),e.render(t,O),n.visible=!0,e.xr.enabled=s,e.shadowMap.autoUpdate=c,e.setRenderTarget(o);let l=r.viewport;l!==void 0&&e.state.viewport(l)}}};function ef(e){if(e&&!(typeof window>`u`)){var t=document.createElement(`style`);return t.setAttribute(`type`,`text/css`),t.innerHTML=e,document.head.appendChild(t),e}}function tf(e,t){var n=e.__state.conversionName.toString(),r=Math.round(e.r),i=Math.round(e.g),a=Math.round(e.b),o=e.a,s=Math.round(e.h),c=e.s.toFixed(1),l=e.v.toFixed(1);if(t||n===`THREE_CHAR_HEX`||n===`SIX_CHAR_HEX`){for(var u=e.hex.toString(16);u.length<6;)u=`0`+u;return`#`+u}else if(n===`CSS_RGB`)return`rgb(`+r+`,`+i+`,`+a+`)`;else if(n===`CSS_RGBA`)return`rgba(`+r+`,`+i+`,`+a+`,`+o+`)`;else if(n===`HEX`)return`0x`+e.hex.toString(16);else if(n===`RGB_ARRAY`)return`[`+r+`,`+i+`,`+a+`]`;else if(n===`RGBA_ARRAY`)return`[`+r+`,`+i+`,`+a+`,`+o+`]`;else if(n===`RGB_OBJ`)return`{r:`+r+`,g:`+i+`,b:`+a+`}`;else if(n===`RGBA_OBJ`)return`{r:`+r+`,g:`+i+`,b:`+a+`,a:`+o+`}`;else if(n===`HSV_OBJ`)return`{h:`+s+`,s:`+c+`,v:`+l+`}`;else if(n===`HSVA_OBJ`)return`{h:`+s+`,s:`+c+`,v:`+l+`,a:`+o+`}`;return`unknown format`}var nf=Array.prototype.forEach,rf=Array.prototype.slice,Q={BREAK:{},extend:function(e){return this.each(rf.call(arguments,1),function(t){(this.isObject(t)?Object.keys(t):[]).forEach(function(n){this.isUndefined(t[n])||(e[n]=t[n])}.bind(this))},this),e},defaults:function(e){return this.each(rf.call(arguments,1),function(t){(this.isObject(t)?Object.keys(t):[]).forEach(function(n){this.isUndefined(e[n])&&(e[n]=t[n])}.bind(this))},this),e},compose:function(){var e=rf.call(arguments);return function(){for(var t=rf.call(arguments),n=e.length-1;n>=0;n--)t=[e[n].apply(this,t)];return t[0]}},each:function(e,t,n){if(e){if(nf&&e.forEach&&e.forEach===nf)e.forEach(t,n);else if(e.length===e.length+0){var r=void 0,i=void 0;for(r=0,i=e.length;r<i;r++)if(r in e&&t.call(n,e[r],r)===this.BREAK)return}else for(var a in e)if(t.call(n,e[a],a)===this.BREAK)return}},defer:function(e){setTimeout(e,0)},debounce:function(e,t,n){var r=void 0;return function(){var i=this,a=arguments;function o(){r=null,n||e.apply(i,a)}var s=n||!r;clearTimeout(r),r=setTimeout(o,t),s&&e.apply(i,a)}},toArray:function(e){return e.toArray?e.toArray():rf.call(e)},isUndefined:function(e){return e===void 0},isNull:function(e){return e===null},isNaN:function(e){function t(t){return e.apply(this,arguments)}return t.toString=function(){return e.toString()},t}(function(e){return isNaN(e)}),isArray:Array.isArray||function(e){return e.constructor===Array},isObject:function(e){return e===Object(e)},isNumber:function(e){return e===e+0},isString:function(e){return e===e+``},isBoolean:function(e){return e===!1||e===!0},isFunction:function(e){return e instanceof Function}},af=[{litmus:Q.isString,conversions:{THREE_CHAR_HEX:{read:function(e){var t=e.match(/^#([A-F0-9])([A-F0-9])([A-F0-9])$/i);return t===null?!1:{space:`HEX`,hex:parseInt(`0x`+t[1].toString()+t[1].toString()+t[2].toString()+t[2].toString()+t[3].toString()+t[3].toString(),0)}},write:tf},SIX_CHAR_HEX:{read:function(e){var t=e.match(/^#([A-F0-9]{6})$/i);return t===null?!1:{space:`HEX`,hex:parseInt(`0x`+t[1].toString(),0)}},write:tf},CSS_RGB:{read:function(e){var t=e.match(/^rgb\(\s*(\S+)\s*,\s*(\S+)\s*,\s*(\S+)\s*\)/);return t===null?!1:{space:`RGB`,r:parseFloat(t[1]),g:parseFloat(t[2]),b:parseFloat(t[3])}},write:tf},CSS_RGBA:{read:function(e){var t=e.match(/^rgba\(\s*(\S+)\s*,\s*(\S+)\s*,\s*(\S+)\s*,\s*(\S+)\s*\)/);return t===null?!1:{space:`RGB`,r:parseFloat(t[1]),g:parseFloat(t[2]),b:parseFloat(t[3]),a:parseFloat(t[4])}},write:tf}}},{litmus:Q.isNumber,conversions:{HEX:{read:function(e){return{space:`HEX`,hex:e,conversionName:`HEX`}},write:function(e){return e.hex}}}},{litmus:Q.isArray,conversions:{RGB_ARRAY:{read:function(e){return e.length===3?{space:`RGB`,r:e[0],g:e[1],b:e[2]}:!1},write:function(e){return[e.r,e.g,e.b]}},RGBA_ARRAY:{read:function(e){return e.length===4?{space:`RGB`,r:e[0],g:e[1],b:e[2],a:e[3]}:!1},write:function(e){return[e.r,e.g,e.b,e.a]}}}},{litmus:Q.isObject,conversions:{RGBA_OBJ:{read:function(e){return Q.isNumber(e.r)&&Q.isNumber(e.g)&&Q.isNumber(e.b)&&Q.isNumber(e.a)?{space:`RGB`,r:e.r,g:e.g,b:e.b,a:e.a}:!1},write:function(e){return{r:e.r,g:e.g,b:e.b,a:e.a}}},RGB_OBJ:{read:function(e){return Q.isNumber(e.r)&&Q.isNumber(e.g)&&Q.isNumber(e.b)?{space:`RGB`,r:e.r,g:e.g,b:e.b}:!1},write:function(e){return{r:e.r,g:e.g,b:e.b}}},HSVA_OBJ:{read:function(e){return Q.isNumber(e.h)&&Q.isNumber(e.s)&&Q.isNumber(e.v)&&Q.isNumber(e.a)?{space:`HSV`,h:e.h,s:e.s,v:e.v,a:e.a}:!1},write:function(e){return{h:e.h,s:e.s,v:e.v,a:e.a}}},HSV_OBJ:{read:function(e){return Q.isNumber(e.h)&&Q.isNumber(e.s)&&Q.isNumber(e.v)?{space:`HSV`,h:e.h,s:e.s,v:e.v}:!1},write:function(e){return{h:e.h,s:e.s,v:e.v}}}}}],of=void 0,sf=void 0,cf=function(){sf=!1;var e=arguments.length>1?Q.toArray(arguments):arguments[0];return Q.each(af,function(t){if(t.litmus(e))return Q.each(t.conversions,function(t,n){if(of=t.read(e),sf===!1&&of!==!1)return sf=of,of.conversionName=n,of.conversion=t,Q.BREAK}),Q.BREAK}),sf},lf=void 0,uf={hsv_to_rgb:function(e,t,n){var r=Math.floor(e/60)%6,i=e/60-Math.floor(e/60),a=n*(1-t),o=n*(1-i*t),s=n*(1-(1-i)*t),c=[[n,s,a],[o,n,a],[a,n,s],[a,o,n],[s,a,n],[n,a,o]][r];return{r:c[0]*255,g:c[1]*255,b:c[2]*255}},rgb_to_hsv:function(e,t,n){var r=Math.min(e,t,n),i=Math.max(e,t,n),a=i-r,o=void 0,s=void 0;if(i!==0)s=a/i;else return{h:NaN,s:0,v:0};return o=e===i?(t-n)/a:t===i?2+(n-e)/a:4+(e-t)/a,o/=6,o<0&&(o+=1),{h:o*360,s,v:i/255}},rgb_to_hex:function(e,t,n){var r=this.hex_with_component(0,2,e);return r=this.hex_with_component(r,1,t),r=this.hex_with_component(r,0,n),r},component_from_hex:function(e,t){return e>>t*8&255},hex_with_component:function(e,t,n){return n<<(lf=t*8)|e&~(255<<lf)}},df=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},ff=function(e,t){if(!(e instanceof t))throw TypeError(`Cannot call a class as a function`)},pf=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,`value`in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),mf=function e(t,n,r){t===null&&(t=Function.prototype);var i=Object.getOwnPropertyDescriptor(t,n);if(i===void 0){var a=Object.getPrototypeOf(t);return a===null?void 0:e(a,n,r)}else if(`value`in i)return i.value;else{var o=i.get;return o===void 0?void 0:o.call(r)}},hf=function(e,t){if(typeof t!=`function`&&t!==null)throw TypeError(`Super expression must either be null or a function, not `+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)},gf=function(e,t){if(!e)throw ReferenceError(`this hasn't been initialised - super() hasn't been called`);return t&&(typeof t==`object`||typeof t==`function`)?t:e},_f=function(){function e(){if(ff(this,e),this.__state=cf.apply(this,arguments),this.__state===!1)throw Error(`Failed to interpret color arguments`);this.__state.a=this.__state.a||1}return pf(e,[{key:`toString`,value:function(){return tf(this)}},{key:`toHexString`,value:function(){return tf(this,!0)}},{key:`toOriginal`,value:function(){return this.__state.conversion.write(this)}}]),e}();function vf(e,t,n){Object.defineProperty(e,t,{get:function(){return this.__state.space===`RGB`||_f.recalculateRGB(this,t,n),this.__state[t]},set:function(e){this.__state.space!==`RGB`&&(_f.recalculateRGB(this,t,n),this.__state.space=`RGB`),this.__state[t]=e}})}function yf(e,t){Object.defineProperty(e,t,{get:function(){return this.__state.space===`HSV`||_f.recalculateHSV(this),this.__state[t]},set:function(e){this.__state.space!==`HSV`&&(_f.recalculateHSV(this),this.__state.space=`HSV`),this.__state[t]=e}})}_f.recalculateRGB=function(e,t,n){if(e.__state.space===`HEX`)e.__state[t]=uf.component_from_hex(e.__state.hex,n);else if(e.__state.space===`HSV`)Q.extend(e.__state,uf.hsv_to_rgb(e.__state.h,e.__state.s,e.__state.v));else throw Error(`Corrupted color state`)},_f.recalculateHSV=function(e){var t=uf.rgb_to_hsv(e.r,e.g,e.b);Q.extend(e.__state,{s:t.s,v:t.v}),Q.isNaN(t.h)?Q.isUndefined(e.__state.h)&&(e.__state.h=0):e.__state.h=t.h},_f.COMPONENTS=[`r`,`g`,`b`,`h`,`s`,`v`,`hex`,`a`],vf(_f.prototype,`r`,2),vf(_f.prototype,`g`,1),vf(_f.prototype,`b`,0),yf(_f.prototype,`h`),yf(_f.prototype,`s`),yf(_f.prototype,`v`),Object.defineProperty(_f.prototype,`a`,{get:function(){return this.__state.a},set:function(e){this.__state.a=e}}),Object.defineProperty(_f.prototype,`hex`,{get:function(){return this.__state.space!==`HEX`&&(this.__state.hex=uf.rgb_to_hex(this.r,this.g,this.b),this.__state.space=`HEX`),this.__state.hex},set:function(e){this.__state.space=`HEX`,this.__state.hex=e}});var bf=function(){function e(t,n){ff(this,e),this.initialValue=t[n],this.domElement=document.createElement(`div`),this.object=t,this.property=n,this.__onChange=void 0,this.__onFinishChange=void 0}return pf(e,[{key:`onChange`,value:function(e){return this.__onChange=e,this}},{key:`onFinishChange`,value:function(e){return this.__onFinishChange=e,this}},{key:`setValue`,value:function(e){return this.object[this.property]=e,this.__onChange&&this.__onChange.call(this,e),this.updateDisplay(),this}},{key:`getValue`,value:function(){return this.object[this.property]}},{key:`updateDisplay`,value:function(){return this}},{key:`isModified`,value:function(){return this.initialValue!==this.getValue()}}]),e}(),xf={HTMLEvents:[`change`],MouseEvents:[`click`,`mousemove`,`mousedown`,`mouseup`,`mouseover`],KeyboardEvents:[`keydown`]},Sf={};Q.each(xf,function(e,t){Q.each(e,function(e){Sf[e]=t})});var Cf=/(\d+(\.\d+)?)px/;function wf(e){if(e===`0`||Q.isUndefined(e))return 0;var t=e.match(Cf);return Q.isNull(t)?0:parseFloat(t[1])}var $={makeSelectable:function(e,t){e===void 0||e.style===void 0||(e.onselectstart=t?function(){return!1}:function(){},e.style.MozUserSelect=t?`auto`:`none`,e.style.KhtmlUserSelect=t?`auto`:`none`,e.unselectable=t?`on`:`off`)},makeFullscreen:function(e,t,n){var r=n,i=t;Q.isUndefined(i)&&(i=!0),Q.isUndefined(r)&&(r=!0),e.style.position=`absolute`,i&&(e.style.left=0,e.style.right=0),r&&(e.style.top=0,e.style.bottom=0)},fakeEvent:function(e,t,n,r){var i=n||{},a=Sf[t];if(!a)throw Error(`Event type `+t+` not supported.`);var o=document.createEvent(a);switch(a){case`MouseEvents`:var s=i.x||i.clientX||0,c=i.y||i.clientY||0;o.initMouseEvent(t,i.bubbles||!1,i.cancelable||!0,window,i.clickCount||1,0,0,s,c,!1,!1,!1,!1,0,null);break;case`KeyboardEvents`:var l=o.initKeyboardEvent||o.initKeyEvent;Q.defaults(i,{cancelable:!0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,keyCode:void 0,charCode:void 0}),l(t,i.bubbles||!1,i.cancelable,window,i.ctrlKey,i.altKey,i.shiftKey,i.metaKey,i.keyCode,i.charCode);break;default:o.initEvent(t,i.bubbles||!1,i.cancelable||!0);break}Q.defaults(o,r),e.dispatchEvent(o)},bind:function(e,t,n,r){var i=r||!1;return e.addEventListener?e.addEventListener(t,n,i):e.attachEvent&&e.attachEvent(`on`+t,n),$},unbind:function(e,t,n,r){var i=r||!1;return e.removeEventListener?e.removeEventListener(t,n,i):e.detachEvent&&e.detachEvent(`on`+t,n),$},addClass:function(e,t){if(e.className===void 0)e.className=t;else if(e.className!==t){var n=e.className.split(/ +/);n.indexOf(t)===-1&&(n.push(t),e.className=n.join(` `).replace(/^\s+/,``).replace(/\s+$/,``))}return $},removeClass:function(e,t){if(t)if(e.className===t)e.removeAttribute(`class`);else{var n=e.className.split(/ +/),r=n.indexOf(t);r!==-1&&(n.splice(r,1),e.className=n.join(` `))}else e.className=void 0;return $},hasClass:function(e,t){return RegExp(`(?:^|\\s+)`+t+`(?:\\s+|$)`).test(e.className)||!1},getWidth:function(e){var t=getComputedStyle(e);return wf(t[`border-left-width`])+wf(t[`border-right-width`])+wf(t[`padding-left`])+wf(t[`padding-right`])+wf(t.width)},getHeight:function(e){var t=getComputedStyle(e);return wf(t[`border-top-width`])+wf(t[`border-bottom-width`])+wf(t[`padding-top`])+wf(t[`padding-bottom`])+wf(t.height)},getOffset:function(e){var t=e,n={left:0,top:0};if(t.offsetParent)do n.left+=t.offsetLeft,n.top+=t.offsetTop,t=t.offsetParent;while(t);return n},isActive:function(e){return e===document.activeElement&&(e.type||e.href)}},Tf=function(e){hf(t,e);function t(e,n){ff(this,t);var r=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n)),i=r;r.__prev=r.getValue(),r.__checkbox=document.createElement(`input`),r.__checkbox.setAttribute(`type`,`checkbox`);function a(){i.setValue(!i.__prev)}return $.bind(r.__checkbox,`change`,a,!1),r.domElement.appendChild(r.__checkbox),r.updateDisplay(),r}return pf(t,[{key:`setValue`,value:function(e){var n=mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`setValue`,this).call(this,e);return this.__onFinishChange&&this.__onFinishChange.call(this,this.getValue()),this.__prev=this.getValue(),n}},{key:`updateDisplay`,value:function(){return this.getValue()===!0?(this.__checkbox.setAttribute(`checked`,`checked`),this.__checkbox.checked=!0,this.__prev=!0):(this.__checkbox.checked=!1,this.__prev=!1),mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`updateDisplay`,this).call(this)}}]),t}(bf),Ef=function(e){hf(t,e);function t(e,n,r){ff(this,t);var i=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n)),a=r,o=i;if(i.__select=document.createElement(`select`),Q.isArray(a)){var s={};Q.each(a,function(e){s[e]=e}),a=s}return Q.each(a,function(e,t){var n=document.createElement(`option`);n.innerHTML=t,n.setAttribute(`value`,e),o.__select.appendChild(n)}),i.updateDisplay(),$.bind(i.__select,`change`,function(){var e=this.options[this.selectedIndex].value;o.setValue(e)}),i.domElement.appendChild(i.__select),i}return pf(t,[{key:`setValue`,value:function(e){var n=mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`setValue`,this).call(this,e);return this.__onFinishChange&&this.__onFinishChange.call(this,this.getValue()),n}},{key:`updateDisplay`,value:function(){return $.isActive(this.__select)?this:(this.__select.value=this.getValue(),mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`updateDisplay`,this).call(this))}}]),t}(bf),Df=function(e){hf(t,e);function t(e,n){ff(this,t);var r=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n)),i=r;function a(){i.setValue(i.__input.value)}function o(){i.__onFinishChange&&i.__onFinishChange.call(i,i.getValue())}return r.__input=document.createElement(`input`),r.__input.setAttribute(`type`,`text`),$.bind(r.__input,`keyup`,a),$.bind(r.__input,`change`,a),$.bind(r.__input,`blur`,o),$.bind(r.__input,`keydown`,function(e){e.keyCode===13&&this.blur()}),r.updateDisplay(),r.domElement.appendChild(r.__input),r}return pf(t,[{key:`updateDisplay`,value:function(){return $.isActive(this.__input)||(this.__input.value=this.getValue()),mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`updateDisplay`,this).call(this)}}]),t}(bf);function Of(e){var t=e.toString();return t.indexOf(`.`)>-1?t.length-t.indexOf(`.`)-1:0}var kf=function(e){hf(t,e);function t(e,n,r){ff(this,t);var i=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n)),a=r||{};return i.__min=a.min,i.__max=a.max,i.__step=a.step,Q.isUndefined(i.__step)?i.initialValue===0?i.__impliedStep=1:i.__impliedStep=10**Math.floor(Math.log(Math.abs(i.initialValue))/Math.LN10)/10:i.__impliedStep=i.__step,i.__precision=Of(i.__impliedStep),i}return pf(t,[{key:`setValue`,value:function(e){var n=e;return this.__min!==void 0&&n<this.__min?n=this.__min:this.__max!==void 0&&n>this.__max&&(n=this.__max),this.__step!==void 0&&n%this.__step!==0&&(n=Math.round(n/this.__step)*this.__step),mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`setValue`,this).call(this,n)}},{key:`min`,value:function(e){return this.__min=e,this}},{key:`max`,value:function(e){return this.__max=e,this}},{key:`step`,value:function(e){return this.__step=e,this.__impliedStep=e,this.__precision=Of(e),this}}]),t}(bf);function Af(e,t){var n=10**t;return Math.round(e*n)/n}var jf=function(e){hf(t,e);function t(e,n,r){ff(this,t);var i=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n,r));i.__truncationSuspended=!1;var a=i,o=void 0;function s(){var e=parseFloat(a.__input.value);Q.isNaN(e)||a.setValue(e)}function c(){a.__onFinishChange&&a.__onFinishChange.call(a,a.getValue())}function l(){c()}function u(e){var t=o-e.clientY;a.setValue(a.getValue()+t*a.__impliedStep),o=e.clientY}function d(){$.unbind(window,`mousemove`,u),$.unbind(window,`mouseup`,d),c()}function f(e){$.bind(window,`mousemove`,u),$.bind(window,`mouseup`,d),o=e.clientY}return i.__input=document.createElement(`input`),i.__input.setAttribute(`type`,`text`),$.bind(i.__input,`change`,s),$.bind(i.__input,`blur`,l),$.bind(i.__input,`mousedown`,f),$.bind(i.__input,`keydown`,function(e){e.keyCode===13&&(a.__truncationSuspended=!0,this.blur(),a.__truncationSuspended=!1,c())}),i.updateDisplay(),i.domElement.appendChild(i.__input),i}return pf(t,[{key:`updateDisplay`,value:function(){return this.__input.value=this.__truncationSuspended?this.getValue():Af(this.getValue(),this.__precision),mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`updateDisplay`,this).call(this)}}]),t}(kf);function Mf(e,t,n,r,i){return r+(i-r)*((e-t)/(n-t))}var Nf=function(e){hf(t,e);function t(e,n,r,i,a){ff(this,t);var o=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n,{min:r,max:i,step:a})),s=o;o.__background=document.createElement(`div`),o.__foreground=document.createElement(`div`),$.bind(o.__background,`mousedown`,c),$.bind(o.__background,`touchstart`,d),$.addClass(o.__background,`slider`),$.addClass(o.__foreground,`slider-fg`);function c(e){document.activeElement.blur(),$.bind(window,`mousemove`,l),$.bind(window,`mouseup`,u),l(e)}function l(e){e.preventDefault();var t=s.__background.getBoundingClientRect();return s.setValue(Mf(e.clientX,t.left,t.right,s.__min,s.__max)),!1}function u(){$.unbind(window,`mousemove`,l),$.unbind(window,`mouseup`,u),s.__onFinishChange&&s.__onFinishChange.call(s,s.getValue())}function d(e){e.touches.length===1&&($.bind(window,`touchmove`,f),$.bind(window,`touchend`,p),f(e))}function f(e){var t=e.touches[0].clientX,n=s.__background.getBoundingClientRect();s.setValue(Mf(t,n.left,n.right,s.__min,s.__max))}function p(){$.unbind(window,`touchmove`,f),$.unbind(window,`touchend`,p),s.__onFinishChange&&s.__onFinishChange.call(s,s.getValue())}return o.updateDisplay(),o.__background.appendChild(o.__foreground),o.domElement.appendChild(o.__background),o}return pf(t,[{key:`updateDisplay`,value:function(){var e=(this.getValue()-this.__min)/(this.__max-this.__min);return this.__foreground.style.width=e*100+`%`,mf(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),`updateDisplay`,this).call(this)}}]),t}(kf),Pf=function(e){hf(t,e);function t(e,n,r){ff(this,t);var i=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n)),a=i;return i.__button=document.createElement(`div`),i.__button.innerHTML=r===void 0?`Fire`:r,$.bind(i.__button,`click`,function(e){return e.preventDefault(),a.fire(),!1}),$.addClass(i.__button,`button`),i.domElement.appendChild(i.__button),i}return pf(t,[{key:`fire`,value:function(){this.__onChange&&this.__onChange.call(this),this.getValue().call(this.object),this.__onFinishChange&&this.__onFinishChange.call(this,this.getValue())}}]),t}(bf),Ff=function(e){hf(t,e);function t(e,n){ff(this,t);var r=gf(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n));r.__color=new _f(r.getValue()),r.__temp=new _f(0);var i=r;r.domElement=document.createElement(`div`),$.makeSelectable(r.domElement,!1),r.__selector=document.createElement(`div`),r.__selector.className=`selector`,r.__saturation_field=document.createElement(`div`),r.__saturation_field.className=`saturation-field`,r.__field_knob=document.createElement(`div`),r.__field_knob.className=`field-knob`,r.__field_knob_border=`2px solid `,r.__hue_knob=document.createElement(`div`),r.__hue_knob.className=`hue-knob`,r.__hue_field=document.createElement(`div`),r.__hue_field.className=`hue-field`,r.__input=document.createElement(`input`),r.__input.type=`text`,r.__input_textShadow=`0 1px 1px `,$.bind(r.__input,`keydown`,function(e){e.keyCode===13&&u.call(this)}),$.bind(r.__input,`blur`,u),$.bind(r.__selector,`mousedown`,function(){$.addClass(this,`drag`).bind(window,`mouseup`,function(){$.removeClass(i.__selector,`drag`)})}),$.bind(r.__selector,`touchstart`,function(){$.addClass(this,`drag`).bind(window,`touchend`,function(){$.removeClass(i.__selector,`drag`)})});var a=document.createElement(`div`);Q.extend(r.__selector.style,{width:`122px`,height:`102px`,padding:`3px`,backgroundColor:`#222`,boxShadow:`0px 1px 3px rgba(0,0,0,0.3)`}),Q.extend(r.__field_knob.style,{position:`absolute`,width:`12px`,height:`12px`,border:r.__field_knob_border+(r.__color.v<.5?`#fff`:`#000`),boxShadow:`0px 1px 3px rgba(0,0,0,0.5)`,borderRadius:`12px`,zIndex:1}),Q.extend(r.__hue_knob.style,{position:`absolute`,width:`15px`,height:`2px`,borderRight:`4px solid #fff`,zIndex:1}),Q.extend(r.__saturation_field.style,{width:`100px`,height:`100px`,border:`1px solid #555`,marginRight:`3px`,display:`inline-block`,cursor:`pointer`}),Q.extend(a.style,{width:`100%`,height:`100%`,background:`none`}),Lf(a,`top`,`rgba(0,0,0,0)`,`#000`),Q.extend(r.__hue_field.style,{width:`15px`,height:`100px`,border:`1px solid #555`,cursor:`ns-resize`,position:`absolute`,top:`3px`,right:`3px`}),Rf(r.__hue_field),Q.extend(r.__input.style,{outline:`none`,textAlign:`center`,color:`#fff`,border:0,fontWeight:`bold`,textShadow:r.__input_textShadow+`rgba(0,0,0,0.7)`}),$.bind(r.__saturation_field,`mousedown`,o),$.bind(r.__saturation_field,`touchstart`,o),$.bind(r.__field_knob,`mousedown`,o),$.bind(r.__field_knob,`touchstart`,o),$.bind(r.__hue_field,`mousedown`,s),$.bind(r.__hue_field,`touchstart`,s);function o(e){f(e),$.bind(window,`mousemove`,f),$.bind(window,`touchmove`,f),$.bind(window,`mouseup`,c),$.bind(window,`touchend`,c)}function s(e){p(e),$.bind(window,`mousemove`,p),$.bind(window,`touchmove`,p),$.bind(window,`mouseup`,l),$.bind(window,`touchend`,l)}function c(){$.unbind(window,`mousemove`,f),$.unbind(window,`touchmove`,f),$.unbind(window,`mouseup`,c),$.unbind(window,`touchend`,c),d()}function l(){$.unbind(window,`mousemove`,p),$.unbind(window,`touchmove`,p),$.unbind(window,`mouseup`,l),$.unbind(window,`touchend`,l),d()}function u(){var e=cf(this.value);e===!1?this.value=i.__color.toString():(i.__color.__state=e,i.setValue(i.__color.toOriginal()))}function d(){i.__onFinishChange&&i.__onFinishChange.call(i,i.__color.toOriginal())}r.__saturation_field.appendChild(a),r.__selector.appendChild(r.__field_knob),r.__selector.appendChild(r.__saturation_field),r.__selector.appendChild(r.__hue_field),r.__hue_field.appendChild(r.__hue_knob),r.domElement.appendChild(r.__input),r.domElement.appendChild(r.__selector),r.updateDisplay();function f(e){e.type.indexOf(`touch`)===-1&&e.preventDefault();var t=i.__saturation_field.getBoundingClientRect(),n=e.touches&&e.touches[0]||e,r=n.clientX,a=n.clientY,o=(r-t.left)/(t.right-t.left),s=1-(a-t.top)/(t.bottom-t.top);return s>1?s=1:s<0&&(s=0),o>1?o=1:o<0&&(o=0),i.__color.v=s,i.__color.s=o,i.setValue(i.__color.toOriginal()),!1}function p(e){e.type.indexOf(`touch`)===-1&&e.preventDefault();var t=i.__hue_field.getBoundingClientRect(),n=1-((e.touches&&e.touches[0]||e).clientY-t.top)/(t.bottom-t.top);return n>1?n=1:n<0&&(n=0),i.__color.h=n*360,i.setValue(i.__color.toOriginal()),!1}return r}return pf(t,[{key:`updateDisplay`,value:function(){var e=cf(this.getValue());if(e!==!1){var t=!1;Q.each(_f.COMPONENTS,function(n){if(!Q.isUndefined(e[n])&&!Q.isUndefined(this.__color.__state[n])&&e[n]!==this.__color.__state[n])return t=!0,{}},this),t&&Q.extend(this.__color.__state,e)}Q.extend(this.__temp.__state,this.__color.__state),this.__temp.a=1;var n=this.__color.v<.5||this.__color.s>.5?255:0,r=255-n;Q.extend(this.__field_knob.style,{marginLeft:100*this.__color.s-7+`px`,marginTop:100*(1-this.__color.v)-7+`px`,backgroundColor:this.__temp.toHexString(),border:this.__field_knob_border+`rgb(`+n+`,`+n+`,`+n+`)`}),this.__hue_knob.style.marginTop=(1-this.__color.h/360)*100+`px`,this.__temp.s=1,this.__temp.v=1,Lf(this.__saturation_field,`left`,`#fff`,this.__temp.toHexString()),this.__input.value=this.__color.toString(),Q.extend(this.__input.style,{backgroundColor:this.__color.toHexString(),color:`rgb(`+n+`,`+n+`,`+n+`)`,textShadow:this.__input_textShadow+`rgba(`+r+`,`+r+`,`+r+`,.7)`})}}]),t}(bf),If=[`-moz-`,`-o-`,`-webkit-`,`-ms-`,``];function Lf(e,t,n,r){e.style.background=``,Q.each(If,function(i){e.style.cssText+=`background: `+i+`linear-gradient(`+t+`, `+n+` 0%, `+r+` 100%); `})}function Rf(e){e.style.background=``,e.style.cssText+=`background: -moz-linear-gradient(top,  #ff0000 0%, #ff00ff 17%, #0000ff 34%, #00ffff 50%, #00ff00 67%, #ffff00 84%, #ff0000 100%);`,e.style.cssText+=`background: -webkit-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);`,e.style.cssText+=`background: -o-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);`,e.style.cssText+=`background: -ms-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);`,e.style.cssText+=`background: linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);`}var zf={load:function(e,t){var n=t||document,r=n.createElement(`link`);r.type=`text/css`,r.rel=`stylesheet`,r.href=e,n.getElementsByTagName(`head`)[0].appendChild(r)},inject:function(e,t){var n=t||document,r=document.createElement(`style`);r.type=`text/css`,r.innerHTML=e;var i=n.getElementsByTagName(`head`)[0];try{i.appendChild(r)}catch{}}},Bf=`<div id="dg-save" class="dg dialogue">
...
</div>`,Vf=function(e,t){var n=e[t];return Q.isArray(arguments[2])||Q.isObject(arguments[2])?new Ef(e,t,arguments[2]):Q.isNumber(n)?Q.isNumber(arguments[2])&&Q.isNumber(arguments[3])?Q.isNumber(arguments[4])?new Nf(e,t,arguments[2],arguments[3],arguments[4]):new Nf(e,t,arguments[2],arguments[3]):Q.isNumber(arguments[4])?new jf(e,t,{min:arguments[2],max:arguments[3],step:arguments[4]}):new jf(e,t,{min:arguments[2],max:arguments[3]}):Q.isString(n)?new Df(e,t):Q.isFunction(n)?new Pf(e,t,``):Q.isBoolean(n)?new Tf(e,t):null};function Hf(e){setTimeout(e,1e3/60)}var Uf=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||Hf,Wf=function(){function e(){ff(this,e),this.backgroundElement=document.createElement(`div`),Q.extend(this.backgroundElement.style,{backgroundColor:`rgba(0,0,0,0.8)`,top:0,left:0,display:`none`,zIndex:`1000`,opacity:0,WebkitTransition:`opacity 0.2s linear`,transition:`opacity 0.2s linear`}),$.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position=`fixed`,this.domElement=document.createElement(`div`),Q.extend(this.domElement.style,{position:`fixed`,display:`none`,zIndex:`1001`,opacity:0,WebkitTransition:`-webkit-transform 0.2s ease-out, opacity 0.2s linear`,transition:`transform 0.2s ease-out, opacity 0.2s linear`}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var t=this;$.bind(this.backgroundElement,`click`,function(){t.hide()})}return pf(e,[{key:`show`,value:function(){var e=this;this.backgroundElement.style.display=`block`,this.domElement.style.display=`block`,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`,this.layout(),Q.defer(function(){e.backgroundElement.style.opacity=1,e.domElement.style.opacity=1,e.domElement.style.webkitTransform=`scale(1)`})}},{key:`hide`,value:function(){var e=this,t=function t(){e.domElement.style.display=`none`,e.backgroundElement.style.display=`none`,$.unbind(e.domElement,`webkitTransitionEnd`,t),$.unbind(e.domElement,`transitionend`,t),$.unbind(e.domElement,`oTransitionEnd`,t)};$.bind(this.domElement,`webkitTransitionEnd`,t),$.bind(this.domElement,`transitionend`,t),$.bind(this.domElement,`oTransitionEnd`,t),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`}},{key:`layout`,value:function(){this.domElement.style.left=window.innerWidth/2-$.getWidth(this.domElement)/2+`px`,this.domElement.style.top=window.innerHeight/2-$.getHeight(this.domElement)/2+`px`}}]),e}(),Gf=ef(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);zf.inject(Gf);var Kf=`dg`,qf=72,Jf=20,Yf=`Default`,Xf=function(){try{return!!window.localStorage}catch{return!1}}(),Zf=void 0,Qf=!0,$f=void 0,ep=!1,tp=[],np=function e(t){var n=this,r=t||{};this.domElement=document.createElement(`div`),this.__ul=document.createElement(`ul`),this.domElement.appendChild(this.__ul),$.addClass(this.domElement,Kf),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],r=Q.defaults(r,{closeOnTop:!1,autoPlace:!0,width:e.DEFAULT_WIDTH}),r=Q.defaults(r,{resizable:r.autoPlace,hideable:r.autoPlace}),Q.isUndefined(r.load)?r.load={preset:Yf}:r.preset&&(r.load.preset=r.preset),Q.isUndefined(r.parent)&&r.hideable&&tp.push(this),r.resizable=Q.isUndefined(r.parent)&&r.resizable,r.autoPlace&&Q.isUndefined(r.scrollable)&&(r.scrollable=!0);var i=Xf&&localStorage.getItem(lp(this,`isLocal`))===`true`,a=void 0,o=void 0;if(Object.defineProperties(this,{parent:{get:function(){return r.parent}},scrollable:{get:function(){return r.scrollable}},autoPlace:{get:function(){return r.autoPlace}},closeOnTop:{get:function(){return r.closeOnTop}},preset:{get:function(){return n.parent?n.getRoot().preset:r.load.preset},set:function(e){n.parent?n.getRoot().preset=e:r.load.preset=e,gp(this),n.revert()}},width:{get:function(){return r.width},set:function(e){r.width=e,mp(n,e)}},name:{get:function(){return r.name},set:function(e){r.name=e,o&&(o.innerHTML=r.name)}},closed:{get:function(){return r.closed},set:function(t){r.closed=t,r.closed?$.addClass(n.__ul,e.CLASS_CLOSED):$.removeClass(n.__ul,e.CLASS_CLOSED),this.onResize(),n.__closeButton&&(n.__closeButton.innerHTML=t?e.TEXT_OPEN:e.TEXT_CLOSED)}},load:{get:function(){return r.load}},useLocalStorage:{get:function(){return i},set:function(e){Xf&&(i=e,e?$.bind(window,`unload`,a):$.unbind(window,`unload`,a),localStorage.setItem(lp(n,`isLocal`),e))}}}),Q.isUndefined(r.parent)){if(this.closed=r.closed||!1,$.addClass(this.domElement,e.CLASS_MAIN),$.makeSelectable(this.domElement,!1),Xf&&i){n.useLocalStorage=!0;var s=localStorage.getItem(lp(this,`gui`));s&&(r.load=JSON.parse(s))}this.__closeButton=document.createElement(`div`),this.__closeButton.innerHTML=e.TEXT_CLOSED,$.addClass(this.__closeButton,e.CLASS_CLOSE_BUTTON),r.closeOnTop?($.addClass(this.__closeButton,e.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):($.addClass(this.__closeButton,e.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),$.bind(this.__closeButton,`click`,function(){n.closed=!n.closed})}else{r.closed===void 0&&(r.closed=!0);var c=document.createTextNode(r.name);$.addClass(c,`controller-name`),o=rp(n,c),$.addClass(this.__ul,e.CLASS_CLOSED),$.addClass(o,`title`),$.bind(o,`click`,function(e){return e.preventDefault(),n.closed=!n.closed,!1}),r.closed||(this.closed=!1)}r.autoPlace&&(Q.isUndefined(r.parent)&&(Qf&&=($f=document.createElement(`div`),$.addClass($f,Kf),$.addClass($f,e.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild($f),!1),$f.appendChild(this.domElement),$.addClass(this.domElement,e.CLASS_AUTO_PLACE)),this.parent||mp(n,r.width)),this.__resizeHandler=function(){n.onResizeDebounced()},$.bind(window,`resize`,this.__resizeHandler),$.bind(this.__ul,`webkitTransitionEnd`,this.__resizeHandler),$.bind(this.__ul,`transitionend`,this.__resizeHandler),$.bind(this.__ul,`oTransitionEnd`,this.__resizeHandler),this.onResize(),r.resizable&&pp(this),a=function(){Xf&&localStorage.getItem(lp(n,`isLocal`))===`true`&&localStorage.setItem(lp(n,`gui`),JSON.stringify(n.getSaveObject()))},this.saveToLocalStorageIfPossible=a;function l(){var e=n.getRoot();e.width+=1,Q.defer(function(){--e.width})}r.parent||l()};np.toggleHide=function(){ep=!ep,Q.each(tp,function(e){e.domElement.style.display=ep?`none`:``})},np.CLASS_AUTO_PLACE=`a`,np.CLASS_AUTO_PLACE_CONTAINER=`ac`,np.CLASS_MAIN=`main`,np.CLASS_CONTROLLER_ROW=`cr`,np.CLASS_TOO_TALL=`taller-than-window`,np.CLASS_CLOSED=`closed`,np.CLASS_CLOSE_BUTTON=`close-button`,np.CLASS_CLOSE_TOP=`close-top`,np.CLASS_CLOSE_BOTTOM=`close-bottom`,np.CLASS_DRAG=`drag`,np.DEFAULT_WIDTH=245,np.TEXT_CLOSED=`Close Controls`,np.TEXT_OPEN=`Open Controls`,np._keydownHandler=function(e){document.activeElement.type!==`text`&&(e.which===qf||e.keyCode===qf)&&np.toggleHide()},$.bind(window,`keydown`,np._keydownHandler,!1),Q.extend(np.prototype,{add:function(e,t){return cp(this,e,t,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,t){return cp(this,e,t,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var t=this;Q.defer(function(){t.onResize()})},destroy:function(){if(this.parent)throw Error(`Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.`);this.autoPlace&&$f.removeChild(this.domElement);var e=this;Q.each(this.__folders,function(t){e.removeFolder(t)}),$.unbind(window,`keydown`,np._keydownHandler,!1),ip(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw Error(`You already have a folder in this GUI by the name "`+e+`"`);var t={name:e,parent:this};t.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(t.closed=this.load.folders[e].closed,t.load=this.load.folders[e]);var n=new np(t);this.__folders[e]=n;var r=rp(this,n.domElement);return $.addClass(r,`folder`),n},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],ip(e);var t=this;Q.each(e.__folders,function(t){e.removeFolder(t)}),Q.defer(function(){t.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display=`none`},show:function(){this.domElement.style.display=``},onResize:function(){var e=this.getRoot();if(e.scrollable){var t=$.getOffset(e.__ul).top,n=0;Q.each(e.__ul.childNodes,function(t){e.autoPlace&&t===e.__save_row||(n+=$.getHeight(t))}),window.innerHeight-t-Jf<n?($.addClass(e.domElement,np.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-t-Jf+`px`):($.removeClass(e.domElement,np.CLASS_TOO_TALL),e.__ul.style.height=`auto`)}e.__resize_handle&&Q.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+`px`}),e.__closeButton&&(e.__closeButton.style.width=e.width+`px`)},onResizeDebounced:Q.debounce(function(){this.onResize()},50),remember:function(){if(Q.isUndefined(Zf)&&(Zf=new Wf,Zf.domElement.innerHTML=Bf),this.parent)throw Error(`You can only call remember on a top level GUI.`);var e=this;Q.each(Array.prototype.slice.call(arguments),function(t){e.__rememberedObjects.length===0&&fp(e),e.__rememberedObjects.indexOf(t)===-1&&e.__rememberedObjects.push(t)}),this.autoPlace&&mp(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||={},e.remembered[this.preset]=hp(this)),e.folders={},Q.each(this.__folders,function(t,n){e.folders[n]=t.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=hp(this),ap(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[Yf]=hp(this,!0)),this.load.remembered[e]=hp(this),this.preset=e,up(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){Q.each(this.__controllers,function(t){this.getRoot().load.remembered?sp(e||this.getRoot(),t):t.setValue(t.initialValue),t.__onFinishChange&&t.__onFinishChange.call(t,t.getValue())},this),Q.each(this.__folders,function(e){e.revert(e)}),e||ap(this.getRoot(),!1)},listen:function(e){var t=this.__listening.length===0;this.__listening.push(e),t&&_p(this.__listening)},updateDisplay:function(){Q.each(this.__controllers,function(e){e.updateDisplay()}),Q.each(this.__folders,function(e){e.updateDisplay()})}});function rp(e,t,n){var r=document.createElement(`li`);return t&&r.appendChild(t),n?e.__ul.insertBefore(r,n):e.__ul.appendChild(r),e.onResize(),r}function ip(e){$.unbind(window,`resize`,e.__resizeHandler),e.saveToLocalStorageIfPossible&&$.unbind(window,`unload`,e.saveToLocalStorageIfPossible)}function ap(e,t){var n=e.__preset_select[e.__preset_select.selectedIndex];t?n.innerHTML=n.value+`*`:n.innerHTML=n.value}function op(e,t,n){if(n.__li=t,n.__gui=e,Q.extend(n,{options:function(t){if(arguments.length>1){var r=n.__li.nextElementSibling;return n.remove(),cp(e,n.object,n.property,{before:r,factoryArgs:[Q.toArray(arguments)]})}if(Q.isArray(t)||Q.isObject(t)){var i=n.__li.nextElementSibling;return n.remove(),cp(e,n.object,n.property,{before:i,factoryArgs:[t]})}},name:function(e){return n.__li.firstElementChild.firstElementChild.innerHTML=e,n},listen:function(){return n.__gui.listen(n),n},remove:function(){return n.__gui.remove(n),n}}),n instanceof Nf){var r=new jf(n.object,n.property,{min:n.__min,max:n.__max,step:n.__step});Q.each([`updateDisplay`,`onChange`,`onFinishChange`,`step`,`min`,`max`],function(e){var t=n[e],i=r[e];n[e]=r[e]=function(){var e=Array.prototype.slice.call(arguments);return i.apply(r,e),t.apply(n,e)}}),$.addClass(t,`has-slider`),n.domElement.insertBefore(r.domElement,n.domElement.firstElementChild)}else if(n instanceof jf){var i=function(t){if(Q.isNumber(n.__min)&&Q.isNumber(n.__max)){var r=n.__li.firstElementChild.firstElementChild.innerHTML,i=n.__gui.__listening.indexOf(n)>-1;n.remove();var a=cp(e,n.object,n.property,{before:n.__li.nextElementSibling,factoryArgs:[n.__min,n.__max,n.__step]});return a.name(r),i&&a.listen(),a}return t};n.min=Q.compose(i,n.min),n.max=Q.compose(i,n.max)}else n instanceof Tf?($.bind(t,`click`,function(){$.fakeEvent(n.__checkbox,`click`)}),$.bind(n.__checkbox,`click`,function(e){e.stopPropagation()})):n instanceof Pf?($.bind(t,`click`,function(){$.fakeEvent(n.__button,`click`)}),$.bind(t,`mouseover`,function(){$.addClass(n.__button,`hover`)}),$.bind(t,`mouseout`,function(){$.removeClass(n.__button,`hover`)})):n instanceof Ff&&($.addClass(t,`color`),n.updateDisplay=Q.compose(function(e){return t.style.borderLeftColor=n.__color.toString(),e},n.updateDisplay),n.updateDisplay());n.setValue=Q.compose(function(t){return e.getRoot().__preset_select&&n.isModified()&&ap(e.getRoot(),!0),t},n.setValue)}function sp(e,t){var n=e.getRoot(),r=n.__rememberedObjects.indexOf(t.object);if(r!==-1){var i=n.__rememberedObjectIndecesToControllers[r];if(i===void 0&&(i={},n.__rememberedObjectIndecesToControllers[r]=i),i[t.property]=t,n.load&&n.load.remembered){var a=n.load.remembered,o=void 0;if(a[e.preset])o=a[e.preset];else if(a[Yf])o=a[Yf];else return;if(o[r]&&o[r][t.property]!==void 0){var s=o[r][t.property];t.initialValue=s,t.setValue(s)}}}}function cp(e,t,n,r){if(t[n]===void 0)throw Error(`Object "`+t+`" has no property "`+n+`"`);var i=void 0;if(r.color)i=new Ff(t,n);else{var a=[t,n].concat(r.factoryArgs);i=Vf.apply(e,a)}r.before instanceof bf&&(r.before=r.before.__li),sp(e,i),$.addClass(i.domElement,`c`);var o=document.createElement(`span`);$.addClass(o,`property-name`),o.innerHTML=i.property;var s=document.createElement(`div`);s.appendChild(o),s.appendChild(i.domElement);var c=rp(e,s,r.before);return $.addClass(c,np.CLASS_CONTROLLER_ROW),i instanceof Ff?$.addClass(c,`color`):$.addClass(c,df(i.getValue())),op(e,c,i),e.__controllers.push(i),i}function lp(e,t){return document.location.href+`.`+t}function up(e,t,n){var r=document.createElement(`option`);r.innerHTML=t,r.value=t,e.__preset_select.appendChild(r),n&&(e.__preset_select.selectedIndex=e.__preset_select.length-1)}function dp(e,t){t.style.display=e.useLocalStorage?`block`:`none`}function fp(e){var t=e.__save_row=document.createElement(`li`);$.addClass(e.domElement,`has-save`),e.__ul.insertBefore(t,e.__ul.firstChild),$.addClass(t,`save-row`);var n=document.createElement(`span`);n.innerHTML=`&nbsp;`,$.addClass(n,`button gears`);var r=document.createElement(`span`);r.innerHTML=`Save`,$.addClass(r,`button`),$.addClass(r,`save`);var i=document.createElement(`span`);i.innerHTML=`New`,$.addClass(i,`button`),$.addClass(i,`save-as`);var a=document.createElement(`span`);a.innerHTML=`Revert`,$.addClass(a,`button`),$.addClass(a,`revert`);var o=e.__preset_select=document.createElement(`select`);if(e.load&&e.load.remembered?Q.each(e.load.remembered,function(t,n){up(e,n,n===e.preset)}):up(e,Yf,!1),$.bind(o,`change`,function(){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].innerHTML=e.__preset_select[t].value;e.preset=this.value}),t.appendChild(o),t.appendChild(n),t.appendChild(r),t.appendChild(i),t.appendChild(a),Xf){var s=document.getElementById(`dg-local-explain`),c=document.getElementById(`dg-local-storage`),l=document.getElementById(`dg-save-locally`);l.style.display=`block`,localStorage.getItem(lp(e,`isLocal`))===`true`&&c.setAttribute(`checked`,`checked`),dp(e,s),$.bind(c,`change`,function(){e.useLocalStorage=!e.useLocalStorage,dp(e,s)})}var u=document.getElementById(`dg-new-constructor`);$.bind(u,`keydown`,function(e){e.metaKey&&(e.which===67||e.keyCode===67)&&Zf.hide()}),$.bind(n,`click`,function(){u.innerHTML=JSON.stringify(e.getSaveObject(),void 0,2),Zf.show(),u.focus(),u.select()}),$.bind(r,`click`,function(){e.save()}),$.bind(i,`click`,function(){var t=prompt(`Enter a new preset name.`);t&&e.saveAs(t)}),$.bind(a,`click`,function(){e.revert()})}function pp(e){var t=void 0;e.__resize_handle=document.createElement(`div`),Q.extend(e.__resize_handle.style,{width:`6px`,marginLeft:`-3px`,height:`200px`,cursor:`ew-resize`,position:`absolute`});function n(n){return n.preventDefault(),e.width+=t-n.clientX,e.onResize(),t=n.clientX,!1}function r(){$.removeClass(e.__closeButton,np.CLASS_DRAG),$.unbind(window,`mousemove`,n),$.unbind(window,`mouseup`,r)}function i(i){return i.preventDefault(),t=i.clientX,$.addClass(e.__closeButton,np.CLASS_DRAG),$.bind(window,`mousemove`,n),$.bind(window,`mouseup`,r),!1}$.bind(e.__resize_handle,`mousedown`,i),$.bind(e.__closeButton,`mousedown`,i),e.domElement.insertBefore(e.__resize_handle,e.domElement.firstElementChild)}function mp(e,t){e.domElement.style.width=t+`px`,e.__save_row&&e.autoPlace&&(e.__save_row.style.width=t+`px`),e.__closeButton&&(e.__closeButton.style.width=t+`px`)}function hp(e,t){var n={};return Q.each(e.__rememberedObjects,function(r,i){var a={},o=e.__rememberedObjectIndecesToControllers[i];Q.each(o,function(e,n){a[n]=t?e.initialValue:e.getValue()}),n[i]=a}),n}function gp(e){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].value===e.preset&&(e.__preset_select.selectedIndex=t)}function _p(e){e.length!==0&&Uf.call(window,function(){_p(e)}),Q.each(e,function(e){e.updateDisplay()})}var vp=np,yp=new sn(0,0,0,`YXZ`),bp=new W,xp={type:`change`},Sp={type:`lock`},Cp={type:`unlock`},wp=.002,Tp=Math.PI/2,Ep=class extends ps{constructor(e,t=null){super(e,t),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=Dp.bind(this),this._onPointerlockChange=Op.bind(this),this._onPointerlockError=kp.bind(this),this.domElement!==null&&this.connect(this.domElement)}connect(e){super.connect(e),this.domElement.ownerDocument.addEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.addEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.addEventListener(`pointerlockerror`,this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.removeEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener(`pointerlockerror`,this._onPointerlockError)}dispose(){this.disconnect()}getDirection(e){return e.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(e){if(this.enabled===!1)return;let t=this.object;bp.setFromMatrixColumn(t.matrix,0),bp.crossVectors(t.up,bp),t.position.addScaledVector(bp,e)}moveRight(e){if(this.enabled===!1)return;let t=this.object;bp.setFromMatrixColumn(t.matrix,0),t.position.addScaledVector(bp,e)}lock(e=!1){this.domElement.requestPointerLock({unadjustedMovement:e})}unlock(){this.domElement.ownerDocument.exitPointerLock()}};function Dp(e){if(this.enabled===!1||this.isLocked===!1)return;let t=this.object;yp.setFromQuaternion(t.quaternion),yp.y-=e.movementX*wp*this.pointerSpeed,yp.x-=e.movementY*wp*this.pointerSpeed,yp.x=Math.max(Tp-this.maxPolarAngle,Math.min(Tp-this.minPolarAngle,yp.x)),t.quaternion.setFromEuler(yp),this.dispatchEvent(xp)}function Op(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(Sp),this.isLocked=!0):(this.dispatchEvent(Cp),this.isLocked=!1)}function kp(){console.error(`THREE.PointerLockControls: Unable to use Pointer Lock API`)}var Ap=new mo,jp=new Iu,Mp=new Xu,Np=new ed,Pp=new Nn,Fp=new Oo(75,window.innerWidth/window.innerHeight,.1,1e4);Fp.position.set(-330,65,-160),Fp.lookAt(0,65,0);var Ip=new Au;Ip.setSize(window.innerWidth,window.innerHeight),Ip.outputColorSpace=Be,Ip.shadowMap.enabled=!0,Ip.shadowMap.type=1,document.body.appendChild(Ip.domElement),Ap.setPath(`images/SkyboxDay/`);var Lp=await Ap.loadAsync([`front.png`,`back.png`,`top.png`,`bottom.png`,`right.png`,`left.png`]);Pp.background=Lp,Ap.setPath(`images/SkyboxNight/`);var Rp=await Ap.loadAsync([`front.png`,`back.png`,`top.png`,`bottom.png`,`right.png`,`left.png`]),zp=new Ep(Fp,Ip.domElement),Bp={speed:100},Vp={forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1},Hp={lightUp:!1,lightDown:!1};document.addEventListener(`click`,function(){zp.lock()},!1),document.addEventListener(`keydown`,function(e){switch(e.code){case`KeyW`:Vp.forward=!0;break;case`KeyA`:Vp.left=!0;break;case`KeyS`:Vp.backward=!0;break;case`KeyD`:Vp.right=!0;break;case`Space`:Vp.up=!0;break;case`ShiftLeft`:Vp.down=!0;break;case`KeyQ`:Hp.lightDown=!0;break;case`KeyE`:Hp.lightUp=!0;break}}),document.addEventListener(`keyup`,function(e){switch(e.code){case`KeyW`:Vp.forward=!1;break;case`KeyS`:Vp.backward=!1;break;case`KeyA`:Vp.left=!1;break;case`KeyD`:Vp.right=!1;break;case`Space`:Vp.up=!1;break;case`ShiftLeft`:Vp.down=!1;break;case`KeyQ`:Hp.lightDown=!1;break;case`KeyE`:Hp.lightUp=!1;break}});var Up=new Wo;Up.connect(document);var Wp=1.5;function Gp(){Up.update();let e=Up.getDelta();Vp.forward&&zp.moveForward(Bp.speed*e),Vp.backward&&zp.moveForward(-Bp.speed*e),Vp.left&&zp.moveRight(-Bp.speed*e),Vp.right&&zp.moveRight(Bp.speed*e),Hp.lightUp&&(tm.rotation.x=Math.min(Math.PI*4,tm.rotation.x+Wp*e)),Hp.lightDown&&(tm.rotation.x=Math.max(0,tm.rotation.x-Wp*e))}var Kp=new J(16115137),qp=2,Jp=new Fo(Kp,qp);Jp.position.set(-2100,0,-2100),Jp.castShadow=!0,Jp.shadow.mapSize.width=2048,Jp.shadow.mapSize.height=2048,Jp.shadow.camera.top=3e3,Jp.shadow.camera.bottom=-3e3,Jp.shadow.camera.left=-3e3,Jp.shadow.camera.right=3e3,Jp.shadow.camera.far=9128,Jp.shadow.camera.updateProjectionMatrix();var Yp=new J(7371136),Xp=1,Zp=new Fo(Yp,Xp);Zp.position.set(2100,0,2100),Zp.castShadow=!0,Zp.shadow.mapSize.width=2048,Zp.shadow.mapSize.height=2048,Zp.shadow.camera.top=3e3,Zp.shadow.camera.bottom=-3e3,Zp.shadow.camera.left=-3e3,Zp.shadow.camera.right=3e3,Zp.shadow.camera.far=9128,Zp.shadow.camera.updateProjectionMatrix();var Qp=new J(16777215),$p=.01,em=new Io(Qp,$p);Pp.add(em);var tm=new Tn;tm.add(Jp,Zp),tm.rotation.x=Math.PI/2,Pp.add(tm),new cs(Jp,50),new cs(Zp,50),new ds(Jp.shadow.camera),new ds(Zp.shadow.camera);var nm=new vp({width:470});nm.add({message:`'Q' and 'E' to change time, or the Light.x slider`},`message`);var rm=nm.addFolder(`Light`);rm.add(tm.rotation,`x`,0,Math.PI*4,.001),rm.open();var im=nm.addFolder(`Movement`);im.add(Bp,`speed`,0,1e3,1),im.open();var am=new ho,om=new Sa(4096,4096,512,512),sm=am.load(`./images/Sand/daySandTexture.png`);sm.wrapS=sm.wrapT=t,sm.repeat.set(128,128),sm.anisotropy=Ip.capabilities.getMaxAnisotropy();var cm=am.load(`./images/Sand/sandHeightMap.jpg`),lm=160,um=am.load(`./images/Sand/sandNormalMap.jpg`),dm=3;um.colorSpace=``;var fm=new hi(om,new Na({map:sm,displacementMap:cm,displacementScale:lm,normalMap:um,normalScale:new U(dm,dm),side:2}));fm.position.set(0,-20,0),fm.rotateX(Fu(-90)),bh(fm,!1,!0),Pp.add(fm);var pm=await Np.loadAsync(`./models/grassTerrain/grassTerrain.glb`),mm=1;pm.scene.scale.set(mm,mm,mm),pm.scene.position.set(0,16,0);var hm=new J(11653516),gm=am.load(`./models/grassTerrain/map.jpg`);gm.wrapS=gm.wrapT=t,gm.repeat.set(16,16),gm.anisotropy=Ip.capabilities.getMaxAnisotropy();var _m=new Na({map:gm,color:hm,normalMap:am.load(`./models/grassTerrain/normal.png`)});pm.scene.traverse(e=>{e.isMesh&&(e.material=_m)}),bh(pm.scene,!1,!0),Pp.add(pm.scene);var vm=new Dr,ym=new Float32Array([0,8,0,-1,0,0,1,0,0]);vm.setAttribute(`position`,new fr(ym,3));var bm=await fetch(`./shaders/grass.vert`),xm=await fetch(`./shaders/grass.frag`),Sm=am.load(`./images/grassNoise.png`);Sm.wrapS=Sm.wrapT=t;var Cm=new ja({uniforms:{time:{value:0},noiseTexture:{value:Sm},directionalDirection:{value:Jp.position.clone().normalize()},directionalColor:{value:Jp.color.clone()},directionalIntensity:{value:Jp.intensity},ambientColor:{value:Qp},ambientIntensity:{value:$p}},vertexShader:await bm.text(),fragmentShader:await xm.text(),side:2}),wm=4e4,Tm=new Vi(vm,Cm,wm);bh(Tm,!0,!0);var Em=new wn,Dm=122,Om=162;for(let e=0;e<wm;e++){let t=Fu(Nu(0,360)),n=Mu(Dm,Om),r=Math.cos(t)*n,i=Math.sin(t)*n;Em.position.set(r,20,i);let a=.3+Nu(0,.3);Em.scale.set(a,a,a),Em.rotation.y=Fu(Nu(0,360)),Em.updateMatrix(),Tm.setMatrixAt(e,Em.matrix)}Pp.add(Tm);var km=new Sa(256,256),Am=new J(6665927),jm=am.load(`./images/waterNormals.jpg`);jm.wrapS=jm.wrapT=t;var Mm=new $d(km,{textureWidth:1024,textureHeight:1024,alpha:.7,waterNormals:jm,sunDirection:Jp.position.clone().normalize(),sunColor:Jp.color.clone(),waterColor:Am,distortionScale:50});Mm.rotateX(Fu(-90)),Mm.position.set(0,16,0),Mm.material.transparent=!0,Pp.add(Mm);var Nm=await jp.loadAsync(`./models/Cactus/cactus.mtl`);Nm.preload(),Mp.setMaterials(Nm);var Pm=await Mp.loadAsync(`./models/Cactus/cactus.obj`),Fm=6;Pm.scale.set(Fm,Fm,Fm),[{x:-1863,y:35,z:-1748},{x:-1142,y:54,z:-1891},{x:-672,y:25,z:-1823},{x:54,y:42,z:-1779},{x:531,y:27,z:-1854},{x:1238,y:32,z:-1706},{x:1747,y:39,z:-1893},{x:-1731,y:32,z:-1147},{x:-1294,y:28,z:-1263},{x:-541,y:28,z:-1183},{x:-87,y:43,z:-1298},{x:642,y:57,z:-1154},{x:1143,y:26,z:-1276},{x:1869,y:34,z:-1132},{x:-1892,y:30,z:-673},{x:-1108,y:12,z:-541},{x:-698,y:20,z:-687},{x:13,y:18,z:-642},{x:547,y:40,z:-714},{x:1261,y:23,z:-538},{x:1714,y:36,z:-662},{x:-1753,y:20,z:-83},{x:-1317,y:9,z:94},{x:-638,y:26,z:-71},{x:583,y:42,z:87},{x:1094,y:20,z:-63},{x:1836,y:20,z:79},{x:-1879,y:15,z:531},{x:-1126,y:25,z:693},{x:-563,y:12,z:514},{x:59,y:27,z:582},{x:641,y:14,z:678},{x:1173,y:22,z:547},{x:1748,y:42,z:632},{x:-1814,y:25,z:1293},{x:-1267,y:30,z:1138},{x:-513,y:27,z:1274},{x:79,y:45,z:1107},{x:558,y:34,z:1289},{x:1302,y:35,z:1154},{x:1731,y:37,z:1247},{x:-1708,y:30,z:1863},{x:-1259,y:23,z:1731},{x:-547,y:26,z:1894},{x:93,y:31,z:1748},{x:638,y:30,z:1817},{x:1184,y:22,z:1762},{x:1853,y:40,z:1839}].forEach(e=>{let t=Im(e.x,e.y,e.z);Pp.add(t)});function Im(e,t,n){let r=Pm.clone();return r.position.set(e,t,n),r.rotateY(Fu(Nu(0,360))),bh(r,!0,!0),r}var Lm=await Np.loadAsync(`./models/PalmTree.glb`);Lm.scene.traverse(function(e){e.isMesh&&(e.material.roughness=.8)});var Rm=12;Lm.scene.scale.set(Rm,Rm,Rm),[{x:125,y:18,z:60,r:45},{x:-140,y:18,z:10,r:270},{x:20,y:18,z:-140,r:150}].forEach(e=>{let t=zm(e.x,e.y,e.z,e.r);Pp.add(t)});function zm(e,t,n,r){let i=Lm.scene.clone();return i.position.set(e,t,n),i.rotateY(Fu(r)),bh(i,!0,!1),i}var Bm=await Np.loadAsync(`./models/Rock.glb`);Bm.scene.traverse(function(e){e.isMesh&&(e.material.roughness=.8)}),[{x:145,y:20,z:5},{x:95,y:20,z:-95},{x:-45,y:20,z:-135},{x:-130,y:20,z:-55},{x:-140,y:20,z:-30},{x:-95,y:20,z:100},{x:20,y:20,z:135}].forEach(e=>{let t=Vm(e.x,e.y,e.z);Pp.add(t)});function Vm(e,t,n){let r=Bm.scene.clone();r.position.set(e,t,n);let i=Nu(3,5);r.scale.set(i,i,i);let a=Fu(Nu(0,360));return r.rotateY(a),bh(r,!0,!1),r}var Hm=await Np.loadAsync(`./models/Flower.glb`);Hm.scene.traverse(function(e){e.isMesh&&(e.material.roughness=.8)}),[{x:130,y:20,z:-15},{x:140,y:20,z:-40},{x:120,y:20,z:-60},{x:120,y:20,z:-85},{x:100,y:20,z:-120},{x:70,y:20,z:-110},{x:50,y:20,z:-140},{x:-10,y:20,z:-130},{x:-20,y:20,z:-150},{x:-70,y:20,z:-125},{x:-95,y:20,z:-125},{x:-90,y:20,z:-100},{x:-120,y:20,z:-90},{x:-110,y:20,z:-65},{x:-140,y:20,z:-70},{x:-140,y:20,z:-45},{x:-125,y:20,z:-30},{x:-155,y:20,z:-10},{x:-125,y:20,z:25},{x:-140,y:20,z:50},{x:-120,y:20,z:60},{x:-115,y:20,z:95},{x:-80,y:20,z:110},{x:-60,y:20,z:135},{x:-50,y:20,z:125},{x:-10,y:20,z:145},{x:15,y:20,z:155},{x:50,y:20,z:130},{x:100,y:20,z:110},{x:95,y:20,z:90},{x:135,y:20,z:80},{x:125,y:20,z:40},{x:150,y:20,z:20}].forEach(e=>{let t=Um(e.x,e.y,e.z);Pp.add(t)});function Um(e,t,n){let r=Hm.scene.clone();r.position.set(e,t,n);let i=Nu(6,8);r.scale.set(i,i,i);let a=Fu(Nu(0,360));return r.rotateY(a),bh(r,!0,!1),r}var Wm=await Np.loadAsync(`./models/Camel.glb`);Wm.scene.traverse(function(e){e.isMesh&&(e.material.roughness=1)}),Wm.scene.position.set(70,19,120);var Gm=14;Wm.scene.scale.set(Gm,Gm,Gm);var Km=-110;Wm.scene.rotation.y=Fu(Km),bh(Wm.scene,!0,!1),Pp.add(Wm.scene);var qm=await Np.loadAsync(`./models/Carpet.glb`);qm.scene.traverse(function(e){e.isMesh&&(e.material.roughness=1)}),qm.scene.position.set(-60,20,-240);var Jm=16;qm.scene.scale.set(Jm,Jm,Jm);var Ym=-30;qm.scene.rotation.y=Fu(Ym),bh(qm.scene,!0,!1),Pp.add(qm.scene);var Xm=await Np.loadAsync(`./models/Tent.glb`);Xm.scene.traverse(function(e){e.isMesh&&(e.material.roughness=1)}),Xm.scene.position.set(-155,20.1,-155);var Zm=10;Xm.scene.scale.set(Zm,Zm,Zm);var Qm=30;Xm.scene.rotation.y=Fu(Qm),bh(Xm.scene,!0,!1),Pp.add(Xm.scene);var $m=await Np.loadAsync(`./models/CampFire.glb`);$m.scene.traverse(function(e){e.isMesh&&(e.material.roughness=1)}),$m.scene.position.set(-18,19.75,-220);var eh=6;$m.scene.scale.set(eh,eh,eh);var th=0;$m.scene.rotation.y=Fu(th),bh($m.scene,!0,!1),Pp.add($m.scene);var nh=new Mo(new J(14256681),300,0,1);nh.position.set(-20,40,-220),nh.castShadow=!0,Pp.add(nh),new is(nh,10);var rh=am.load(`./images/fireParticleWhite.png`),ih=class extends qr{constructor(e,t,n,r,i,a,o,s){let c=new Nr({color:t,map:e,alphaTest:r,opacity:i,transparent:!0}),l,u=a,d=s;if(o===void 0)l=1;else{let e=Math.random()*o;l=e>1?e:1}s!==void 0&&(d=Math.random()*s,d=d>0?d:.01),super(c),this.position.set(Pu(15),0,Pu(15)),this.startTime=xh.getElapsed(),this.currentTime,this.scale.set(l,l,l),this.randRotation=d,this.myRotation=u,this.lerpToColor=n,this.material.blending=2}update(e){this.position.y+=30*e,this.updateMatrix(),this.updateMatrixWorld(),this.myRotation!==void 0&&(this.material.rotation+=this.myRotation),this.randRotation!==void 0&&(this.material.rotation+=this.randRotation),this.material.color.lerp(new J(this.lerpToColor),.003)}},ah=class{constructor(e,t,n,r,i,a,o,s){this.particles=[],this.group=new Tn,this.timer=0,this.color=t,this.lerpToColor=n,this.texture=e,this.alphaTest=r,this.opacity=i,this.myRotation=a,this.randomScale=o,this.randomRotation=s,Pp.add(this.group)}emitParticle(){let e=new ih(this.texture,this.color,this.lerpToColor,this.alphaTest,this.opacity,this.myRotation,this.randomScale,this.randomRotation);e.currentTime=xh.getElapsed(),this.group.add(e),this.particles.push(e)}updateParticles(e){this.particles=this.particles.filter(t=>(t.currentTime=xh.getElapsed(),t.currentTime-t.startTime>1?(this.group.remove(t),t.material.dispose(),!1):(t.update(e),!0)))}},oh={texture:rh,color:16711680,lerpToColor:11184640,alphaTest:.001,opacity:.3,rotationFactor:void 0,scaleFactor:10,randRotationFactor:.003},sh=new ah(oh.texture,oh.color,oh.lerpToColor,oh.alphaTest,oh.opacity,oh.rotationFactor,oh.scaleFactor,oh.randRotationFactor);sh.group.position.set(-20,28,-220);var ch=0,lh=60,uh=await Np.loadAsync(`./models/Pyramid.glb`);uh.scene.traverse(function(e){e.isMesh&&(e.material.roughness=1,e.material.metalness=.5)}),bh(uh.scene,!0,!1),[{x:1500,y:10,z:1500,scale:2.5,rotation:-30},{x:1700,y:10,z:900,scale:2,rotation:-15}].forEach(e=>{let t=dh(e.x,e.y,e.z,e.scale,e.rotation);Pp.add(t)});function dh(e,t,n,r,i){let a=uh.scene.clone();return a.position.set(e,t,n),a.scale.set(r,r,r),a.rotation.y=Fu(i),a}var fh=await Np.loadAsync(`./models/Fish.glb`),ph=[{x:-4,y:4,z:-8},{x:0,y:8,z:-4},{x:4,y:4,z:-8},{x:-6,y:4,z:0},{x:0,y:4,z:0},{x:6,y:4,z:0},{x:-4,y:4,z:8},{x:0,y:8,z:4},{x:4,y:4,z:8},{x:-6,y:0,z:-6},{x:0,y:0,z:-6},{x:6,y:0,z:-6},{x:-8,y:0,z:0},{x:8,y:0,z:0},{x:-6,y:0,z:6},{x:0,y:0,z:6},{x:6,y:0,z:6},{x:-4,y:-4,z:-8},{x:0,y:-8,z:-4},{x:4,y:-4,z:-8},{x:-6,y:-4,z:0},{x:0,y:-4,z:0},{x:6,y:-4,z:0},{x:-4,y:-4,z:8},{x:0,y:-8,z:4},{x:4,y:-4,z:8}],mh=hh();_h(mh),Pp.add(mh);function hh(){let e=new Tn;return ph.forEach(t=>{e.add(gh(t.x,t.y,t.z))}),e}function gh(e,t,n){let r=fh.scene.clone(),i=1.5;return r.scale.set(i,i,i),r.position.set(e,t,n),r}function _h(){mh.children.forEach(e=>{let t=e.position;e.position.set(t.x+55,t.y+0,t.z)})}function vh(e){mh.rotateY(e)}function yh(e){let t=Math.PI/8;mh.children.forEach((n,r)=>{let i=r/10;n.rotation.y=Math.sin(e+i)*t})}function bh(e,t,n){e.traverse(e=>{e.isMesh&&(e.castShadow=t,e.receiveShadow=n)})}var xh=new Wo,Sh=new W;function Ch(){Gp(),xh.update();let e;Jp.getWorldPosition(Sh),Sh.y>100?(e=Jp,Jp.intensity=qp,Zp.intensity=0,Pp.background=Lp):(e=Zp,Zp.intensity=Xp,Jp.intensity=0,Pp.background=Rp),e.getWorldPosition(Sh),Cm.uniforms.directionalDirection.value.copy(Sh).normalize(),Cm.uniforms.directionalColor.value.copy(e.color),Cm.uniforms.directionalIntensity.value=e.intensity/2,Mm.material.uniforms.sunDirection.value.copy(Sh).normalize(),Mm.material.uniforms.sunColor.value.copy(e.color);let t=xh.getDelta();Mm.material.uniforms.time.value+=t,Cm.uniforms.time.value+=t,ch+=t;let n=1/lh;for(;ch>=n;)sh.emitParticle(),ch-=n;sh.updateParticles(t),vh(Fu(-10*t)),yh(20*xh.getElapsed()),Ip.render(Pp,Fp)}function wh(){requestAnimationFrame(wh),Ch()}wh();